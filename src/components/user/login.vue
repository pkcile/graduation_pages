 ...
 * @LastEditTime: 2021-10-25 18:23:54
...
export default {
  ...
  methods: {
    loginIn() {
      ...
      if(this.login.username && this.login.password) {
        axios.get(`${process.env.VUE_APP_POSITION_PATH}/api/position/login`, {params: _this.login})
          .then(returnData => {
  ...
  created() {
    const _this = this;
    this.$store.commit("Login/loginIn", {aa: 12312, _this });
  }
};
</script>
