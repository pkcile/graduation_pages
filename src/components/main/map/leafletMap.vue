 ...
 * @LastEditTime: 2022-02-28 20:59:40
...
export default {
  ...
  methods: {
    initDate() {
      ...
      L.tileLayer(
        "https://api.mapbox.com/styles/v3/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw",
        {
          maxZoom: 18,
