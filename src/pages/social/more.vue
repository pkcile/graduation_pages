 ...
 * @LastEditors: 王朋坤
 * @LastEditTime: 2022-05-10 12:49:06
...
export default {
  beforeCreate() {
    const _this = this;
    // // 数据发送
    // axios.get(`${process.env.VUE_APP_POSITION_PATH}/api/position/recordShow`).then(function(returnData) {
    //   console.log(returnData.data);
    //   _this.currentContact = returnData.data.recordShow;
    //   console.log(_this.currentContact);
        ...
        admin: {
          ...
          items: [
            ...
            },
            {
              ...
              key: "004",
              backgroundimg: require("@/assets/font/empoty.svg"),
              show: true
            },
            {
              name: "任务查看",
