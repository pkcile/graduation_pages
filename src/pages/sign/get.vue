 ...
 * @LastEditTime: 2022-02-28 22:35:36
...
<template>
  <div class="mine-send-part-absolute-sign" style="width:100%;height:100%;background:#fff;">
    ...
    <ul class="send-main">
      ...
      <section :id="mapid" style="width: 100%; height: 230px;"></section>
      <div class="sign-get">
...
export default {
  ...
  methods: {
    initMap(position) {
      ...
      const map = new initLeaflet(this.mapid, defaultConfig);
      this.map = map;
